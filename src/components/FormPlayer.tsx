        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          {screen === 'welcome' && (
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-4">Drücke <kbd className="bg-gray-100 border border-gray-300 px-1.5 py-0.5 rounded text-xs text-gray-600">Enter ↵</kbd> zum Starten</p>
            </motion.div>
          )}
